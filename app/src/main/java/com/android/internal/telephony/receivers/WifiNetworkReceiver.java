package com.android.internal.telephony.receivers;
...
public class WifiNetworkReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if(this.wifiManager == null) wifiManager = (WifiManager) context.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
